<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Metadata.aspx.cs" Inherits="TigerConnectAspNetWebApp.Metadata" %>
...
<head runat="server">
    ...
    <title>TigerConnect asp.net Sample - Metadata</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="default.aspx">TigerConnect Asp.net Web Sample</a>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">Metadata (Coming Soon)</h3>
                            </div>
